<template>
  ...
  <div>
    <img src="https://images.unsplash.com/photo-1585713181935-d5f622cc2415?q=80&w=1771&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
    
  </div>
  <div class="containermain">
  <p class="container-title mt-10">WHY CHOOSE<br>OUR</p>
  ...
  <div class="gradient-cards">
    <div class="cardmain">
      <div class="container-card bg-green-box">
        ...
        <p class="card-description">We believe in providing cost-effective solutions without compromising on the quality of our delivery service</p>
      </div>
    </div>
    ...
    <div class="cardmain">
      <div class="container-card bg-white-box">
        ...
        <p class="card-title">Shipping to various countries</p>
        <p class="card-description"> providing products and services to a wide range of customers worldwide.</p>
      </div>
    </div>
    ...
    <div class="cardmain">
      <div class="container-card bg-yellow-box">
        ...
        <p class="card-title">on-time delivery</p>
        <p class="card-description">Our company is committed to ensuring on-time delivery of all orders.</p>
      </div>
    </div>
    ...
    <div class="cardmain">
      <div class="container-card bg-blue-box">
        ...
        <p class="card-title">fast shipping</p>
        <p class="card-description">facilitating the smooth movement of goods between countries</p>
      </div>
    </div>
  </div>
</div>
  <h1 class="text1 mt-20 font-bold animate__animated animate__fadeIn"> WELCOME TO PT AKSI</h1>
